...
function Discount({}: Props) {
  return (
    <div className='bg-gradient-to-b from-content-start mt-24 md:mt-32 py-12 to-content-end  rounded-3xl flex flex-col md:flex-row-reverse justify-around items-center w-[90%] max-w-4xl mx-auto '>
